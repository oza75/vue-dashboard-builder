...
export interface Config {
  ...
  icons: { edit: string; show: string; remove: string; play: string; loading: string; sort: string; sortUp: string; sortDown: string; [key: string]: string };
  loginForm?: { title?: string; buttonText?: string; url: string; fields: Array<{ label: string; name: string; type?: string }>; retrieveAccessToken: (res: any) => string };
  accessToken: string;
  isLogged?: () => boolean;
